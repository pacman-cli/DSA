...
class Stack {
  int n, top; // 'n' is the maximum size of the stack, 'top' is the index of the
              // top element
...
int main() {
  ...
  s1.push(35); // Attempt to push 35, but stack is full, so it will print an error
